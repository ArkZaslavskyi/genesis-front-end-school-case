...
Задача — створити застосунок для навчання.

## API

https://www.postman.com/aninix/workspace/genesis-front-end-school/overview,
його необхідно форкнути у свій акаунт postman.
...
При натисканні на пункт "Courses" головного меню выдкривається перша сторінка с курсами.
